...
import {View, FlatList, Image,Alert, List, TextInput, TouchableOpacity, ScrollView} from 'react-native'
...
class uploadDalamMikro extends Component{
    state = {
        filePath: {},
      };
      ...
      static navigationOptions = ({ navigation }) => {
        return {
            headerTitle: 'Tempat Usaha (Dalam)',
      ...
      // console.warn(this.state.filePath)
        return(
          <Container>
            ...
            <Text style={{color:'green'}}>Ambil/Pilih Foto Tempat Usaha (Dalam)</Text>
          </Button>
          <Button 
...
export default connect(mapStateToProps)(uploadDalamMikro)