...
class uploadSKPegawai extends Component{
    state = {
        filePath: {},
      };
      ...
      uploadFile = async() => {
        ...
        await AsyncStorage.setItem("linkSKPegawai",this.props.uploadProp.dataUpload)
        ...
        return(
          <Container>
           ...
           <Image
            ...
            <Text style={{color:'green'}}>Ambil/Pilih Gambar SK</Text>
          </Button>
          <Button 
...
export default connect(mapStateToProps)(uploadSKPegawai)