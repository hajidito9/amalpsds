...
class uploadKKMikro extends Component{
    state = {
        filePath: {},
      };
      ...
      uploadFile = async() => {
        ...
        await AsyncStorage.setItem("linkKKMikro",this.props.uploadProp.dataUpload)
...
export default connect(mapStateToProps)(uploadKKMikro)