...
class uploadDepanMikro extends Component{
    state = {
        filePath: {},
      };
      ...
      uploadFile = async() => {
        ...
        await AsyncStorage.setItem("linkDepanMikro",this.props.uploadProp.dataUpload)
      ...
      static navigationOptions = ({ navigation }) => {
        return {
            headerTitle: 'Foto Tempat Usaha (Depan)',
        ...
        return(
          <Container>
           ...
           <Image
            ...
            <Text style={{color:'green'}}>Ambil/Pilih Foto Tempat Usaha (Depan)</Text>
          </Button>
          <Button 
...
export default connect(mapStateToProps)(uploadDepanMikro)