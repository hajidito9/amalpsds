...
class uploadKKPegawai extends Component{
    state = {
        filePath: {},
      };
      ...
      uploadFile = async() => {
        ...
        await AsyncStorage.setItem("linkKKPegawai",this.props.uploadProp.dataUpload)
        ...
        return(
          <Container>
           ...
           <Image
            ...
            <Text style={{color:'green'}}>Ambil/Pilih Gambar KK</Text>
          </Button>
          <Button 
...
export default connect(mapStateToProps)(uploadKKPegawai)