...
class uploadSlipPegawai extends Component{
    state = {
        filePath: {},
      };
      ...
      uploadFile = async() => {
        ...
        await AsyncStorage.setItem("linkSlipPegawai",this.props.uploadProp.dataUpload)
    ...
    //   }
        ...
        return(
          <Container>
            ...
            <Text style={{color:'green'}}>Ambil/Pilih Gambar Slip Gaji</Text>
          </Button>
          <Button 
...
export default connect(mapStateToProps)(uploadSlipPegawai)