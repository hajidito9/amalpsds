...
class uploadKtpMikro extends Component{
    state = {
        filePath: {},
      };
      ...
      uploadFile = async() => {
        ...
        await AsyncStorage.setItem("linkKtpMikro",this.props.uploadProp.dataUpload)
...
export default connect(mapStateToProps)(uploadKtpMikro)