...
import { getDpTabEmas } from '../publics/redux/actions/nasabah';
...
class DetailKendaraanAdmin extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        headerTitle: 'Uang Muka Tabungan Emas',
    ...
    componentDidMount = async () => {
        ...
        this.subs = [
            this.props.navigation.addListener('willFocus', async () => {
                ...
                await this.props.dispatch(getDpTabEmas(nasabah_id))
                    ...
                    <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                        <View style={{ flexDirection: 'column' }}>
                            <List>
                                ...
                                <ListItem style={{ alignSelf: 'flex-start' }}>
                                    <Text style={{ color: 'grey' }}>Jumlah Gram: </Text>
                                </ListItem>
                                <ListItem style={{ alignSelf: 'flex-start' }}>
                                    <Text style={{ color: 'grey' }}>Konversi Rupiah: </Text>
                                </ListItem>
                                <ListItem style={{ alignSelf: 'flex-start' }}>
                        ...
                        <View style={{ flexDirection: 'column' }}>
                            <List>
                                ...
                                <ListItem style={{ alignSelf: 'flex-end' }}>
                                    <Text style={{ color: "black", alignSelf: 'flex-end' }}>{this.state.gram}g</Text>
                                </ListItem>
                                <ListItem style={{ alignSelf: 'flex-end' }}>
                                    <NumberFormat value={this.state.konversi} displayType={'text'} thousandSeparator={true} prefix={'Rp'} renderText={value => <Text style={{ color: "black", alignSelf: 'flex-end' }}>{value}</Text>} />
                                </ListItem>
                                <ListItem style={{ alignSelf: 'flex-end' }}>
